...
// node_modules/.pnpm/tsup@7.3.0_@swc+core@1.3.96_typescript@5.4.5/node_modules/tsup/assets/cjs_shims.js
...
function makeVisitor(babel) {
  ...
  return {
    Program(path, state) {
      ...
      state.util = new import_babel_import_util.ImportUtil(babel, path);
