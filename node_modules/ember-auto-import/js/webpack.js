...
class WebpackBundler extends broccoli_plugin_1.default {
    ...
    *withResolvableExtensions(importSpecifier) {
    ...
    addDiscoveredExternals(build) {
        for (let assetFiles of build.entrypoints.values()) {
            for (let assetFile of assetFiles) {
                ...
                (0, fs_1.writeFileSync)((0, path_1.resolve)(this.outputPath, assetFile), outputSrc, 'utf8');
            }
        }
    }
    ...
    writeEntryFile(name, deps) {
        (0, fs_1.writeFileSync)((0, path_1.join)(this.stagingDir, `${name}.cjs`), entryTemplate({
    ...
    writeLoaderFile() {
        (0, fs_1.writeFileSync)((0, path_1.join)(this.stagingDir, `l.cjs`), loader);
    }
    linkDeps(bundleDeps) {
